...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    else if (*v)
    {
        ...
        window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x + (pad * 2), check_bb.Min.y + (pad * 2)), ImVec2(check_bb.Max.x - (pad * 2), check_bb.Max.y - (pad * 2)), ImColor(97, 4, 219), style.FrameRounding);
    }
